...
describe("generate-locale-html SEO smoke", () => {
  ...
  it("generates locale-specific html with canonical and hreflang tags", () => {
    ...
    expect(localeHtml[0]).toContain('<link rel="canonical" href="https://creadordejocs.com/" />')
    expect(localeHtml[1]).toContain('<link rel="canonical" href="https://creadordejocs.com/es" />')
    expect(localeHtml[2]).toContain('<link rel="canonical" href="https://creadordejocs.com/en" />')
  ...
  it("builds sitemap with alternates and x-default", () => {
    ...
    expect(sitemap).toContain("<loc>https://creadordejocs.com/</loc>")
    expect(sitemap).toContain("<loc>https://creadordejocs.com/es</loc>")
    expect(sitemap).toContain("<loc>https://creadordejocs.com/en</loc>")
