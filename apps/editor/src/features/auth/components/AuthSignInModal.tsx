  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 p-4" onClick={() => onClose()}>
      ...
      >
        ...
        <p className="mt-1 text-sm text-slate-600">Enviarem un magic link al teu correu electronic.</p>
        <form className="mt-4 space-y-3" onSubmit={handleFormSubmit}>
          ...
          <div className="flex items-center justify-end gap-2 pt-1">
            ...
            <Button type="submit" size="sm" data-testid="auth-send-magic-link-button" disabled={isSubmitting}>
              {isSubmitting ? "Enviant..." : "Enviar magic link"}
            </Button>
          </div>
        </form>
      </div>
