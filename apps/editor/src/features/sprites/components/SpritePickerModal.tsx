  ...
  const renderFolderNode = (folderEntry: SpriteFolderOption, depth: number) => {
    ...
    return (
      <div key={folderEntry.id} className="mvp16-sprite-picker-tree-folder">
        <button
          type="button"
          className="mvp16-sprite-picker-tree-folder-row flex min-h-[38px] w-full items-center gap-2 border border-transparent px-2 py-1.5 text-left text-xs text-slate-700 hover:border-slate-200 hover:bg-slate-50"
          style={{ paddingLeft: `${depth * 14 + 10}px` }}
        ...
        <div className="mvp16-sprite-picker-body flex h-[460px] overflow-hidden">
          ...
          <section className="mvp16-sprite-picker-preview-panel flex flex-1 flex-col">
            <div className="border-b border-slate-200 px-4 py-2">
              <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-500">{t("spritePickerPreviewLabel")}</p>
            </div>
